...
const Favorite = () => {
 const options = {
  ...
  return (
   <div class="trending-container pb-6">
   <div className="text-white text-xl md:text-2xl font-semibold mb-4 flex items-center">
     <div>
       <img src="/assets/icons/favorite-svgrepo-com.svg" alt="" className="w-6 h-6 mr-2" />
     </div>
     <div>Favoites Animes</div>
   </div>
         ...
         <div className="trending-content flex justify-center rounded-lg mb-3 cursor-pointer ">
           <div className="trending-card rounded-lg">
             <div>
               ...
               <div className="trending-info w-32 mt-2">
                 <div className="title text-sm md:text-md">My Hero Academy</div>
               </div>
               <div className="trending-rating bottom-section flex items-center text-white mt-1">
                 <i class="bx bxs-star mr-2 text-xl text-orange-500"></i>
                 <div className="text-gray-300 text-sm">80%</div>
         ...
         <div className="trending-content flex justify-center rounded-lg mb-3 cursor-pointer ">
           <div className="trending-card rounded-lg">
             <div>
               ...
               <div className="trending-info w-32 mt-2">
                 <div className="title text-sm md:text-md">Huner X Hunter</div>
               </div>
               <div className="trending-rating bottom-section flex items-center text-white mt-1">
                 <i class="bx bxs-star mr-2 text-xl text-orange-500"></i>
                 <div className="text-gray-300 text-sm">80%</div>
         ...
         <div className="trending-content flex justify-center rounded-lg mb-3 cursor-pointer ">
           <div className="trending-card rounded-lg">
             <div>
               ...
               <div className="trending-info w-32 mt-2">
                 <div className="title text-sm md:text-md">Attack On Titan</div>
               </div>
               <div className="trending-rating bottom-section flex items-center text-white mt-1">
                 <i class="bx bxs-star mr-2 text-xl text-orange-500"></i>
                 <div className="text-gray-300 text-sm">80%</div>
         ...
         <div className="trending-content flex justify-center rounded-lg mb-3 cursor-pointer ">
           <div className="trending-card rounded-lg">
             <div>
               ...
               <div className="trending-info w-32 mt-2">
                 <div className="title text-sm md:text-md">Full Metal Archimist</div>
               </div>
               <div className="trending-rating bottom-section flex items-center text-white mt-1">
                 <i class="bx bxs-star mr-2 text-xl text-orange-500"></i>
                 <div className="text-gray-300 text-sm">80%</div>
         ...
         <div className="trending-content flex justify-center rounded-lg mb-3 cursor-pointer ">
           <div className="trending-card rounded-lg">
             <div>
               ...
               <div className="trending-info w-32 mt-2">
                 <div className="title text-sm md:text-md">One Piece</div>
               </div>
               <div className="trending-rating bottom-section flex items-center text-white mt-1">
                 <i class="bx bxs-star mr-2 text-xl text-orange-500"></i>
                 <div className="text-gray-300 text-sm">80%</div>
